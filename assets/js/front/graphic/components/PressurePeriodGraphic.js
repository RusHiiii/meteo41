...
function usePressurePeriodGraphic({ data, history, period, unit }, inView) {
  ...
  useEffect(() => {
    ...
    dispatch({
      ...
      minTime: new Date(history.minRelativePressureReceivedAt).getTime(),
      maxTime: new Date(history.maxRelativePressureReceivedAt).getTime(),
...
export default React.memo(PressurePeriodGraphic);
