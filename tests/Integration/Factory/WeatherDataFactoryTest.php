...
class WeatherDataFactoryTest extends TestCase
{
    ...
    public function testCreateDataFromCommand()
    {
        ...
        $weatherData = $this->weatherDataFactory->createWeatherDataFromCommand($command, 23, 23, 1020.3, 1003.3, 12, 13, 45, 12, 0, 0, 0, 0, 0, 0, 123, 24, 12, 23, 960, 1, 12, 23, 20, 20, '5', new \DateTime(), $entities['unit_1'], $entities['weather_station_1']);
